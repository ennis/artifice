use crate::ui::common::platform::{Direct2dDrawContext, PlatformWindow};
use crate::ui::common::WindowCtx;
use crate::ui::kyute::layout::{Bounds, Point, Size};
use crate::ui::kyute::renderer::colors::DEFAULT_COLORS;
use crate::ui::kyute::renderer::metrics::WIDGET_METRICS;
use crate::ui::kyute::renderer::ButtonState;
use crate::ui::kyute::renderer::WidgetMetrics;
...
impl Renderer {
    ...
    pub fn new(ctx: &WindowCtx) -> Renderer {
        let dwrite = ctx.platform().directwrite().clone();
