...
use crate::render::gl::handle::{FramebufferHandle, RenderbufferHandle};
...
impl SwapChainResources {
    ...
    unsafe fn with_gl_interop(
        ...
        let renderbuffer = RenderbufferHandle::from_raw(&gl, renderbuffer);
...
impl PlatformWindow {
    ...
    pub fn resize(&mut self, ctx: &WindowCtx, (width, height): (u32, u32)) -> Result<()> {
    ...
    pub fn new(ctx: &WindowCtx, builder: WindowBuilder, with_gl: bool) -> Result<PlatformWindow> {
