use crate::document::{Document, DocumentChangeListener, DocumentId, SceneId};
use crate::ui::{RunLoopCtx, WindowEventTarget};
...
use crate::ui::platform::PlatformWindow;
...
impl WindowEventTarget for DocumentWindowHandler {
    ...
    fn paint(&mut self, ctx: &mut RunLoopCtx) {
        // paint here!
        self.window.draw_gl(|gl, fbo| unsafe {
